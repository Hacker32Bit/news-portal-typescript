  ...
  const news = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1631771970274-d7f0442bd28b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDExfHx8ZW58MHx8fHx8&w=1000&q=80",
    ...
    },
    {
      ...
      image:
        "https://yourblogworks.com/wp-content/uploads/2016/07/Free-images-1024x683.jpg",
      publishDate: new Date().toDateString(),
    },
    {
      id: 4,
      ...
      image:
        "https://img.freepik.com/premium-photo/hand-holding-camera-dslr-travel-river-sunset-holiday-travel-vintage_10541-1063.jpg",
      publishDate: new Date().toDateString(),
    },
  ];
